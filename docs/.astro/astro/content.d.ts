...
"architecture/safety.md": {
	id: "architecture/safety.md";
  slug: "architecture/safety";
  body: string;
  collection: "docs";
  data: InferEntrySchema<"docs">
} & { render(): Render[".md"] };
"architecture/strategies.md": {
	id: "architecture/strategies.md";
  slug: "architecture/strategies";
  body: string;
  collection: "docs";
  data: InferEntrySchema<"docs">
} & { render(): Render[".md"] };
"architecture/thesis.md": {
	id: "architecture/thesis.md";
  slug: "architecture/thesis";
  body: string;
  collection: "docs";
  data: InferEntrySchema<"docs">
} & { render(): Render[".md"] };
"benchmark/reproduce.md": {
	id: "benchmark/reproduce.md";
  slug: "benchmark/reproduce";
  body: string;
  collection: "docs";
  data: InferEntrySchema<"docs">
} & { render(): Render[".md"] };
"benchmark/results.md": {
	id: "benchmark/results.md";
...
"guides/reliability.md": {
	id: "guides/reliability.md";
  slug: "guides/reliability";
  body: string;
  collection: "docs";
  data: InferEntrySchema<"docs">
} & { render(): Render[".md"] };
